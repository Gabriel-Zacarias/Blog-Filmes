    ...
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <nav class="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto">
            <a href="{{ route('blog.filmes')}}" class="mr-5 hover:text-gray-900">Filmes</a>
            <a class="mr-5 hover:text-gray-900">Séries</a>
            <a class="mr-5 hover:text-gray-900">outra coisa</a>
            <a class="hover:text-gray-900">outra ideia</a>
          </nav>
          <a class="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
            ...
            <span class="ml-3 text-xl">Blog Filmes </span>
          </a>
          <div class="lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
            <button class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">Admin
    ...
    <footer class="text-gray-600">
        ...
        <div class="bg-gray-100">
            <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                <p class="text-gray-500 text-sm text-center sm:text-left">© 2023 Antônio — Gabriel
                    <a href="https://github.com/Antonio-pf/Blog-Filmes" class="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">@github</a>
                </p>
